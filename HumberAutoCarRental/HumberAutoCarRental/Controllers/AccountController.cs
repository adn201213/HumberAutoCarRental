...
namespace HumberAutoCarRental.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            using (var db = ApplicationDbContext.Create())
            {
                ...
                RegisterViewModel newUser = new RegisterViewModel
                {
                  ...
                  //  .Where(m => !m.Name.ToLower().Equals(SD.AdminUserRole.ToLower())).ToList()
                    // .Where(m => !m.Name.ToLower().Equals(SD.AdminUserRole.ToLower()))
                };
                return View(newUser);
            }
        }
        ...
        {
            List<SelectListItem> MembershipTypesDropDown = new List<SelectListItem>();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    using (var db = ApplicationDbContext.Create())
                    {
                        ...
                        {
                            //For Super Admin
                            await roleManager.CreateAsync(new IdentityRole(Utility.SD.AdminUserRole));
